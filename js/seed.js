...
export async function seedWorld(keepClock) {
  ...
  const units = [
    ...
    { id: 'us-cvn', kind: 'ship', countryId: 'us', callsign: 'USS Harbor Star', type: 'Lotniskowiec', operator: 'US Navy', category: 'Military', route: [P('Północny Atlantyk', 55.0, -20.0), P('Morze Północne', 57.0, 3.5)], depTime: T0 - 30 * H, duration: 70 * H, mission: 'Military', missionVisible: true, visibility: 'public' },
